...
covers: [openaegis_pilot_overview.md]
covers_token_total: 304
summary_level: d1
token_count: 293
type: summary
---
# OpenAegis Pilot Structural Summary

The OpenAegis Pilot establishes the core architecture for clinical workflow automation, focusing on policy-gated inference and audit integrity.

### Workflow and Architecture
The pilot follows a sequential flow: Clinician Initiation â†’ Policy Evaluation (`REQUIRE_APPROVAL` for high-risk operations) â†’ Approval â†’ Model Inference â†’ Audit Logging.
...
Refer to `openaegis_pilot_overview.md` for full implementation details and test results.
