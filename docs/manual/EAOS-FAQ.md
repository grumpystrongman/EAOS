...
## What problem does EAOS solve?
EAOS enables secure enterprise AI agent orchestration with policy enforcement, approvals, and audit replay.

## Is this a chatbot framework?
No. EAOS is infrastructure for regulated enterprise agent workflows.

## How does EAOS prevent data leakage?
...
Yes. EAOS model broker is vendor-neutral and supports adapter-based routing.
