...
OpenAegis is a vendor-neutral enterprise agent orchestration and trust platform for regulated organizations, starting with hospitals and health systems. The MVP is designed to make every agent action policy-governed, approval-aware, auditable, and replayable.
...
- Event contracts on `openaegis.control.*` topics/subjects.
